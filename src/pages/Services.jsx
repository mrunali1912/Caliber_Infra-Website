...
const Products = ({
  ...
  // Handle add to cart: uses parent's addToCart, manages qty per product
            ...
            <div className="p-6">
              ...
              {cartItems.length === 0 ? (
                ...
                <div className="space-y-4">
                  {cartItems.map((item) => (
                    <div key={item.cartId || item.id} className="bg-gray-50 p-4 rounded-lg">
          ...
          {filteredProducts.map((product) => {
            ...
            return (
              <ProductCard
                ...
                setQuantity={val => setQuantities(q => ({ ...q, [product.id]: val }))}
              />
            );
          })}
        </div>
