...
import { User, Building2, Award, Target, Users, Leaf, CheckCircle, Lightbulb } from 'lucide-react';


const About = () => {
  const milestones = [
    { year: '2018', event: 'Company Founded', description: 'Gaurav Giri established Caliber Enterprise with a vision to provide quality construction materials.' },
    { year: '2019', event: 'Manufacturing Plant', description: 'Set up our state-of-the-art 2-acre manufacturing facility with modern equipment.' },
    ...
    <div className="py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-16">
          <h1 className="text-4xl font-bold text-gray-900">About Caliber Enterprise</h1>
  ...
  <img
    src="/founder/gauravGiri.jpeg"
    alt="CEO Gaurav Giri"
    className="rounded-2xl shadow-2xl border-4 border-white max-h-80 object-cover w-full lg:w-[480px] transition-shadow duration-300 hover:shadow-[0_8px_32px_rgba(255,135,44,0.16)]"
  />
        ...
        <section className="bg-white rounded-2xl p-8 mb-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <div className="absolute -top-6 -left-6 bg-white p-6 rounded-xl shadow-lg">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <div className="font-bold text-gray-900">2-Acre Facility</div>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4 text-gray-600 leading-relaxed">
                <p>
                  Our state-of-the-art 2-acre manufacturing facility is equipped with the latest 
  ...
  <div className="space-y-20">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      <div>
        <div className="flex items-start gap-4 mb-4">
          <img src="/bricks-strength-test-hammer.webp" alt="Vision Icon" className="w-10 h-10" />
          <h3 className="text-4xl font-semibold text-[#262B50]">Our Vision</h3>
        </div>
    
        <p className="text-gray-600 leading-relaxed">
          To be the most trusted and innovative brick manufacturing company in India, committed
          to delivering superior quality, sustainable building materials that strengthen the
          foundation of every construction project. We aim to set new benchmarks in the
          industry by continuously adopting modern technology, enhancing product durability,
          and promoting environmentally responsible practices. Our vision encompasses not
          only exceptional products but also empowering our employees, supporting local
          communities, and contributing to the creation of safer, stronger, and more
      ...
      <div className="flex justify-center">
        <img
          ...
          alt="Our Vision"
          className="rounded-2xl border-4 border-white shadow-2xl max-h-80 object-contain w-full md:w-[370px] shadow-top-bottom"
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
      <div className="flex justify-center order-2 md:order-1">
        <img
          src="/gallary-fly-ash-brick.webp"
          alt="Our Mission"
          className="rounded-2xl border-4 border-white shadow-2xl max-h-80 object-cover w-full md:w-[400px] shadow-top-bottom"
    
        />
      </div>
      <div className="order-1 md:order-2">
        <div className="flex items-start gap-4 mb-4">
          <img src="/brick-factory.webp" alt="Mission Icon" className="w-10 h-10" />
          <h3 className="text-4xl font-semibold text-[#262B50]">Our Mission</h3>
        </div>
        <p className="text-gray-600 leading-relaxed">
          To provide construction professionals with durable, eco-friendly bricks produced
          through cutting-edge technology and sustainable practices, ensuring excellence in
          every batch. Our mission is to exceed client expectations by offering products
          that combine strength, longevity, and aesthetic appeal, while maintaining strict
          quality control standards. We are dedicated to minimizing environmental impact,
          supporting community development, and fostering innovation in the building
          materials industry. Through continuous research, employee training, and
          strategic partnerships, we strive to empower builders, architects, and engineers
          to create structures that are not only robust but also sustainable and cost-efficient.
        </p>
      </div>
    </div>
  </div>
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                <img 
                  src="founder/gauravGiriCrop.jpeg" 
                  alt="CEO"
                  className="w-32 h-32 rounded-full mx-auto mb-4 object-cover"
                />
                <h3 className="text-xl font-semibold text-gray-900">Gaurav Giri</h3>
                <p className="text-blue-600">Founder & CEO</p>
                <p className="text-gray-600 mt-2">Visionary leader with 5+ years in construction industry</p>
              </div>
              <div className="text-center">
                <img 
      ...
      <a
        href="/products" 
        className="inline-block bg-orange-700 text-white font-semibold py-3 px-8 rounded-2xl hover:bg-orange-500 transition-colors"
      >
