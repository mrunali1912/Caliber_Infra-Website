        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8">
          ...
          <div className="space-y-4 ml-8">
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="text-2xl font-bold">Caliber Enterprise</span>
            </div>
            ...
            <div className="flex space-x-4 pt-2">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="hover:text-orange-400 transition-colors">
              ...
              <a href="https://www.linkedin.com/in/gaurav-giri25" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-orange-400 transition-colors">
          ...
          <div className="space-y-4 ml-12">
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              {['Cement Bricks (4", 6", 9")', 'Flyash Bricks (4", 6")', 'Paver Blocks', 'Custom Size Bricks'].map((item, idx) => (
        ...
        <div className="border-t border-gray-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
            <p className="mb-2 md:mb-0 text-center md:text-left">
              © {new Date().getFullYear()} Caliber Enterprise. All rights reserved.
            </p>
